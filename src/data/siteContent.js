...
const siteContent = {
  common: {
    ...
    motto: { en: 'Empowering Lives, Ensuring Rights', bn: 'জীবনমান উন্নয়ন ও অধিকার নিশ্চিতকরণ' },
    contact: {
      email: 'info@spus.org',
      phone: '+880123456789',
    ...
    buttons: {
      ...
      donateNow: { en: "Donate Now", bn: "এখনই অনুদান দিন" },
  ...
  nav: {
    ...
    specialPrograms: { en: 'Special Programs', bn: 'বিশেষ কর্মসূচি' },
    ...
    donors: { en: 'Donors', bn: 'দাতাগণ' },
  },
  home: {
    hero: {
      slides: [
        {
          title: { en: "Empowering Lives, Ensuring Rights.", bn: "জীবনমান উন্নয়ন ও অধিকার নিশ্চিতকরণ" },
          subtitle: { en: "Dedicated to the welfare and rights of persons with disabilities.", bn: "প্রতিবন্ধী ব্যক্তিদের কল্যাণ ও অধিকার রক্ষায় আমরা অঙ্গীকারাবদ্ধ।" },
        ...
        },
        {
          ...
          subtitle: { en: "Providing essential healthcare and assistive devices to our community.", bn: "অসহায় মানুষের জন্য স্বাস্থ্যসেবা ও প্রয়োজনীয় সহায়ক উপকরণ নিশ্চিত করছি।" },
    ...
    about: {
      ...
      title: { en: "Working for an Inclusive Society", bn: "একটি বৈষম্যহীন সমাজ গঠনে আমরা নিবেদিত" },
      description: { en: "Swadhin Protibondhi Unnayan Sangstha (SPUS) is a non-political, non-profit organization dedicated to the welfare and rights of persons with disabilities.", bn: "সাতারকুল প্রতিবন্ধী উন্নয়ন সংস্থা (এসপিইউএস) একটি অরাজনৈতিক ও অলাভজনক সংস্থা, যা প্রতিবন্ধী ব্যক্তিদের অধিকার ও কল্যাণে কাজ করে চলেছে।" },
      since: { en: "Since 2013", bn: "২০১৩ সাল থেকে" },
      sinceDesc: { en: "Dedicated to empowering persons with disabilities in Badda, Dhaka.", bn: "ঢাকার বাড্ডায় প্রতিবন্ধী ব্যক্তিদের স্বাবলম্বী করতে আমরা নিবেদিত।" },
      discoverMore: { en: "Discover More About Us", bn: "আমাদের সম্পর্কে আরও বিস্তারিত" }
    },
    stats: {
    ...
    programs: {
      tag: { en: "Our Impact Areas", bn: "আমাদের কার্যক্রমের ক্ষেত্র" },
    ...
    testimonials: {
      tag: { en: "Our Voices", bn: "আমাদের কথা" },
      title: { en: "Stories of Hope and Resilience", bn: "আশা এবং ঘুরে দাঁড়ানোর গল্প" },
      description: { en: "Hear from the people whose lives have been transformed through our programs and collective efforts.", bn: "আমাদের কর্মসূচি ও সম্মিলিত প্রচেষ্টায় যাদের জীবন বদলে গেছে, তাদের মুখ থেকেই শুনুন।" },
      ...
      list: [
        {
          ...
          quote: { en: 'SPUS has given my son a new lease on life. The education and care he receives here are unmatched.', bn: 'এসপিইউএস আমার ছেলেকে নতুন জীবনের দিশা দেখিয়েছে। এখানকার শিক্ষা ও নিবিড় যত্ন সত্যিই অতুলনীয়।' },
          image: 'https://i.pravatar.cc/150?u=rahim'
        },
        {
          name: { en: 'Fatema Begum', bn: 'ফাতেমা বেগম' },
          role: { en: 'Member', bn: 'সদস্য' },
          quote: { en: 'The assistive devices and health support from SPUS have made me independent and confident.', bn: 'এসপিইউএস-এর স্বাস্থ্য সহায়তা ও সহায়ক উপকরণ আমাকে স্বাধীনভাবে চলার আত্মবিশ্বাস দিয়েছে।' },
          image: 'https://i.pravatar.cc/150?u=fatema'
        }
      ]
    },
    partners: {
      tag: { en: "Our Trusted Partners", bn: "আমাদের বিশ্বস্ত অংশীদারবৃন্দ" }
    },
    join: {
      volunteer: {
        title: { en: "Become a Volunteer", bn: "স্বেচ্ছাসেবী হিসেবে যোগ দিন" },
        desc: { en: "Join our community of passionate volunteers and help us create a more inclusive world.", bn: "আমাদের নিবেদিতপ্রাণ স্বেচ্ছাসেবক দলে যোগ দিয়ে একটি অন্তর্ভুক্তিমূলক সমাজ গড়তে সহায়তা করুন।" }
      },
      partner: {
        title: { en: "Partner With Us", bn: "আমাদের সাথে অংশীদার হোন" },
        desc: { en: "Collaborate with us to scale our impact and reach more people in need.", bn: "আরও বেশি মানুষের কাছে সেবা পৌঁছে দিতে আমাদের উন্নয়ন সহযোগী হিসেবে পাশে থাকুন।" }
      }
    },
    cta: {
      title: { en: "Ready to Make a Real Difference?", bn: "আপনি কি একটি ইতিবাচক পরিবর্তন আনতে প্রস্তুত?" },
      desc: { en: "Your contribution helps us provide education, healthcare, and dignity to persons with disabilities.", bn: "আপনার সামান্য অবদান প্রতিবন্ধী ব্যক্তিদের শিক্ষা, চিকিৎসা এবং সম্মান নিশ্চিত করতে আমাদের সাহায্য করবে।" }
    },
    newsletter: {
      title: { en: "Stay Informed", bn: "যুক্ত থাকুন আমাদের সাথে" },
      desc: { en: "Subscribe to our newsletter for the latest updates and impact stories.", bn: "আমাদের সর্বশেষ আপডেট এবং সফলতার গল্পগুলো জানতে সাবস্ক্রাইব করুন।" },
  ...
  about: {
    page: {
      ...
      subtitle: { en: "A journey of compassion, resilience, and empowerment since 2013.", bn: "২০১৩ সাল থেকে মমতা, মনোবল এবং স্বনির্ভরতার এক নিরন্তর পথচলা।" }
    },
    legacy: {
      tag: { en: "Our Legacy", bn: "আমাদের অর্জন" },
      title: { en: "Empowering Lives Since 2013", bn: "২০১৩ থেকে সক্ষমতার পথে" },
      description: { en: "Satarkul Protibondhi Unnayan Songstha (SPUS) emerged from a collective vision to ensure the rights of persons with disabilities in family, society, and state.", bn: "পরিবার, সমাজ এবং রাষ্ট্রে প্রতিবন্ধী ব্যক্তিদের অধিকার নিশ্চিত করার লক্ষ্য নিয়ে সাতারকুল প্রতিবন্ধী উন্নয়ন সংস্থা (এসপিইউএস) যাত্রা শুরু করে।" },
      type: { en: "Type", bn: "ধরণ" },
      typeVal: { en: "Non-Profit NGO", bn: "অলাভজনক এনজিও" },
      regNo: { en: "Reg No", bn: "নিবন্ধন নং" },
      regNoVal: "Dha-09437",
      yearsService: { en: "Years of dedicated service to the community.", bn: "দশকজুড়ে মানুষের সেবায় নিবেদিত এক পথচলা।" },
      yearsServiceVal: "10+",
      heroAlt: { en: "Education Community photo", bn: "শিক্ষা ও উন্নয়নমূলক কার্যক্রম" }
    },
    mission: {
      title: { en: "Our Mission", bn: "আমাদের লক্ষ্য" },
      text: { en: "To ensure the rights and dignity of every person with a disability in family, society, and state.", bn: "পরিবার, সমাজ ও রাষ্ট্রের প্রতিটি স্তরে প্রতিবন্ধী ব্যক্তির অধিকার ও সম্মান নিশ্চিত করা।" }
    },
    vision: {
      title: { en: "Our Vision", bn: "আমাদের স্বপ্ন" },
      text: { en: "A society where disability is not a barrier to success and every individual can reach their full potential.", bn: "এমন একটি বৈষম্যহীন সমাজ গড়ে তোলা যেখানে প্রতিবন্ধকতা কোনো বাধা হবে না এবং প্রতিটি মানুষ তার পূর্ণ সম্ভাবনা বিকাশ করতে পারবে।" }
    },
    philosophy: {
      title: { en: "Our Philosophy of Change to a new dimention", bn: "পরিবর্তনের নতুন দিগন্তে আমাদের দর্শন" },
      subtitle: { en: "We believe in a holistic and selective approach to social transformation, focusing on four core pillars.", bn: "আমরা চারটি মূল স্তম্ভের ওপর ভিত্তি করে সামাজিক রূপান্তরে বিশ্বাস করি।" },
      list: [
        { id: 'education', title: { en: 'Education', bn: 'শিক্ষা' }, desc: { en: 'Empowering through knowledge and skill development.', bn: 'জ্ঞান এবং দক্ষতা উন্নয়নের মাধ্যমে সক্ষমতা বৃদ্ধি।' } },
        ...
        { id: 'rights', title: { en: 'Rights & Justice', bn: 'অধিকার ও ন্যায়বিচার' }, desc: { en: 'Advocating for legal rights and social equity.', bn: 'আইনি অধিকার এবং সামাজিক সমতা নিশ্চিতকরণ।' } },
        { id: 'empowerment', title: { en: 'Empowerment', bn: 'ক্ষমতায়ন' }, desc: { en: 'Creating opportunities for self-reliance.', bn: 'স্বনির্ভর হয়ে গড়ে ওঠার সুযোগ সৃষ্টি করা।' } },
      ]
    },
    timeline: {
      title: { en: "Our Growth Timeline", bn: "আমাদের পথচলার ইতিহাস" },
      subtitle: { en: "Tracing our steps from a small initiative to a recognized organization.", bn: "একটি ক্ষুদ্র উদ্যোগ থেকে একটি সুপ্রতিষ্ঠিত সংস্থায় রূপান্তরের ধাপগুলো।" },
      list: [
        { year: '2013', title: { en: 'Foundation', bn: 'প্রতিষ্ঠা' }, desc: { en: 'SPUS was founded on 28th December to serve Badda, Bhatara, and Satarkul.', bn: '২৮ ডিসেম্বর বাড্ডা, ভাটারা ও সাতারকুল এলাকার মানুষের সেবায় এসপিইউএস-এর জন্ম।' } },
        { year: '2017', title: { en: 'Registration', bn: 'নিবন্ধন' }, desc: { en: 'Officially registered with the Department of Social Welfare, Dhaka.', bn: 'সমাজসেবা অধিদপ্তর, ঢাকা থেকে আমরা নিবন্ধিত হই।' } },
        { year: 'Today', title: { en: 'Growing Impact', bn: 'ক্রমবর্ধমান প্রভাব' }, desc: { en: 'Serving thousands of disabled individuals across our work areas.', bn: 'বর্তমানে আমরা আমাদের কর্ম এলাকায় হাজারো মানুষের সেবায় নিয়োজিত।' } },
      ]
    },
    whoWeServe: {
      title: { en: "Who We Serve", bn: "আমরা যাদের পাশে আছি" },
      description: { en: "Our primary focus is the empowerment of persons with disabilities, with a special emphasis on women and children who face double marginalization.", bn: "আমরা মূলত প্রতিবন্ধী ব্যক্তিদের জন্য কাজ করি, বিশেষ করে অবহেলিত নারী ও শিশুদের অধিকার রক্ষায় আমাদের বিশেষ গুরুত্ব রয়েছে।" },
      list: [
        { en: 'Ultra poor disabled women and men', bn: 'অতি দরিদ্র ও অসহায় প্রতিবন্ধী নারী ও পুরুষ' },
    ...
    transparency: {
      title: { en: 'Transparency & Resources', bn: 'স্বচ্ছতা ও তথ্য' },
      subtitle: { en: 'Access our official documents and annual reports.', bn: 'আমাদের অফিসিয়াল নথি এবং বার্ষিক প্রতিবেদনগুলো এখান থেকে দেখুন।' },
    ...
    membership: {
      page: {
        ...
        subtitle: { en: 'Become a member and contribute to a more inclusive society.', bn: 'সদস্য হয়ে একটি সুন্দর ও অন্তর্ভুক্তিমূলক সমাজ গঠনে ভূমিকা রাখুন।' },
      },
      stats: [
      ...
      benefits: {
        title: { en: 'Why Join Us?', bn: 'কেন আমাদের সাথে যুক্ত হবেন?' },
        subtitle: { en: 'Membership offers unique opportunities for growth and contribution.', bn: 'সদস্যপদ আপনার ব্যক্তিগত বিকাশ এবং জনহিতৈষী কাজে অংশগ্রহণের দারুণ সুযোগ দেয়।' },
        list: [
          { title: { en: 'Voice & Representation', bn: 'অধিকার ও প্রতিনিধিত্ব' }, desc: { en: 'Participate in decision-making processes and represent the disabled community.', bn: 'সিদ্ধান্ত গ্রহণ প্রক্রিয়ায় অংশ নিন এবং প্রতিবন্ধী সমাজের প্রতিনিধিত্ব করুন।' }, icon: 'Users', color: 'text-primary', bg: 'bg-primary/10' },
          { title: { en: 'Skill Development', bn: 'দক্ষতা উন্নয়ন' }, desc: { en: 'Access to exclusive training programs, workshops, and vocational courses.', bn: 'বিভিন্ন কর্মশালা এবং বৃত্তিমূলক প্রশিক্ষণের মাধ্যমে নিজেকে দক্ষ করে তুলুন।' }, icon: 'Star', color: 'text-secondary', bg: 'bg-secondary/10' },
          { title: { en: 'Community Support', bn: 'পারস্পরিক সহযোগিতা' }, desc: { en: 'Join a network of peers and professionals dedicated to mutual empowerment.', bn: 'একই লক্ষ্যের মানুষের সাথে মিলে একটি শক্তিশালী নেটওয়ার্ক তৈরি করুন।' }, icon: 'Heart', color: 'text-accent', bg: 'bg-accent/10' },
        ]
      },
      steps: {
        title: { en: 'How to Join', bn: 'সদস্য হওয়ার প্রক্রিয়া' },
        subtitle: { en: 'Follow these simple steps to become a registered member.', bn: 'নিবন্ধিত সদস্য হতে নিচের সহজ ধাপগুলো অনুসরণ করুন।' },
        list: [
          { title: { en: 'Eligibility Check', bn: 'যোগ্যতা যাচাই' }, desc: { en: 'Ensure you meet the criteria for membership as a person with disability.', bn: 'প্রতিবন্ধী ব্যক্তি হিসেবে সদস্যপদ পাওয়ার শর্তাবলি সম্পর্কে জানুন।' }, icon: 'ClipboardCheck' },
          { title: { en: 'Form Submission', bn: 'আবেদনপত্র জমা' }, desc: { en: 'Fill out the membership application form available at our office.', bn: 'আমাদের অফিস থেকে সদস্য ফরম সংগ্রহ করে তা পূরণ করে জমা দিন।' }, icon: 'UserPlus' },
          { title: { en: 'Verification', bn: 'যাচাইকরণ' }, desc: { en: 'Our committee will review and verify your application details.', bn: 'আমাদের কার্যনির্বাহী কমিটি আপনার আবেদনটি যাচাই-বাছাই করে অনুমোদন দেবে।' }, icon: 'UserCheck' },
        ]
      },
      childrenBreakdown: {
      ...
      cta: {
        title: { en: 'Ready to Make an Impact?', bn: 'আপনি কি ইতিবাচক ভূমিকা রাখতে চান?' },
        desc: { en: 'Join us today and help us build a world where everyone has equal opportunities.', bn: 'আজই আমাদের সাথে যোগ দিন এবং সবার জন্য সমান সুযোগের একটি পৃথিবী গড়ে তুলতে সাহায্য করুন।' }
      }
    },
    workArea: {
      page: {
        title: { en: 'Our Work Area', bn: 'আমাদের কর্ম এলাকা' },
        subtitle: { en: 'Expanding our reach to create an inclusive Dhaka.', bn: 'একটি বৈষম্যহীন ঢাকা গড়ে তুলতে আমরা আমাদের কার্যক্রম ছড়িয়ে দিচ্ছি।' },
      },
      stats: [
        { label: { en: 'Wards Covered', bn: 'অন্তর্ভুক্ত ওয়ার্ড সমূহ' }, value: '11', icon: 'MapPin', color: 'text-primary', bg: 'bg-primary/10', details: '২০, ২১, ২২, ২৩, ২৪, ৩৭, ৩৮, ৩৯, ৪০, ৪১, ৪২' },
        { label: { en: 'Persons Served', bn: 'সেবাপ্রাপ্ত ব্যক্তি' }, value: '690+', icon: 'Users', color: 'text-secondary', bg: 'bg-secondary/10', details: { en: 'Empowering 690+ persons with disabilities.', bn: '৬৯০ জনেরও বেশি প্রতিবন্ধী ব্যক্তিকে সহায়তা দেওয়া হয়েছে।' } },
      ...
      locationFocus: {
        tag: { en: 'Location Focus', bn: 'নির্দিষ্ট অবস্থান' },
        title: { en: 'Strategic Reach Across Dhaka', bn: 'ঢাকা জুড়ে আমাদের সেবার বিস্তার' },
        description: { en: 'We are actively working in several wards of Badda Thana and surrounding areas to support the local disabled community through grassroots initiatives.', bn: 'বাড্ডা থানাসহ ঢাকার আশেপাশের বিভিন্ন ওয়ার্ডে আমরা তৃণমূল পর্যায়ের প্রতিবন্ধী মানুষের উন্নয়নে কাজ করছি।' },
        list: [
      ...
      cta: {
        ...
        desc: { en: 'Located in the heart of Satarkul, our office is open for consultations and community support.', bn: 'সাতারকুলের প্রাণকেন্দ্রে অবস্থিত আমাদের অফিসে আপনি পরামর্শ এবং সহায়তার জন্য আসতে পারেন।' }
      }
    },
    support: {
      page: {
        title: { en: 'Support Our Mission', bn: 'আমাদের মিশনে পাশে থাকুন' },
        subtitle: { en: 'There are many ways to contribute to our cause. Choose the one that fits you best.', bn: 'আমাদের কার্যক্রমে নানাভাবে অবদান রাখতে পারেন। আপনার পছন্দের উপায়টি বেছে নিন।' }
      },
      hero: {
        title: { en: 'Your Support Changes Lives', bn: 'আপনার সামান্য সমর্থন জীবন বদলে দিতে পারে' },
        description: { en: 'Every contribution, whether big or small, helps us provide essential services and advocate for the rights of persons with disabilities.', bn: 'আপনার প্রতিটি অনুদান প্রতিবন্ধী ব্যক্তিদের প্রয়োজনীয় সেবা নিশ্চিত করতে এবং তাদের অধিকার আদায়ে আমাদের শক্তি যোগাবে।' }
      },
      options: [
        {
          id: 'donate',
          title: { en: 'Donate Now', bn: 'এখনই অনুদান দিন' },
          description: { en: 'Financial contributions go directly to our programs, providing education, health, and skill training.', bn: 'আপনার আর্থিক অনুদান সরাসরি শিক্ষা, স্বাস্থ্য এবং দক্ষতা উন্নয়নমূলক কাজে ব্যয় করা হয়।' },
          icon: 'Heart',
          link: '/support/donate',
          color: 'text-primary',
          bg: 'bg-primary/10'
        ...
        {
          id: 'volunteer',
          title: { en: 'Volunteer', bn: 'স্বেচ্ছাসেবী হিসেবে যোগ দিন' },
          description: { en: 'Share your time and skills to help us manage events, mentor youth, or support our admin team.', bn: 'আপনার সময় ও দক্ষতা দিয়ে আমাদের ইভেন্ট পরিচালনা বা প্রশিক্ষণে সাহায্য করুন।' },
          icon: 'Users',
        ...
        {
          id: 'partner',
          title: { en: 'Partner With Us', bn: 'আমাদের অংশীদার হোন' },
          description: { en: 'Organizations can collaborate with us through CSR initiatives, joint programs, or sponsorships.', bn: 'বিভিন্ন প্রতিষ্ঠান সিএসআর (CSR) বা যৌথ কর্মসূচির মাধ্যমে আমাদের সাথে কাজ করতে পারে।' },
          icon: 'Handshake',
        ...
        },
        {
          ...
          description: { en: 'See the organizations and individuals who make our work possible through their generous support.', bn: 'যাদের উদার সহযোগিতায় আমাদের এই পথচলা সম্ভব হয়েছে, তাদের সম্পর্কে জানুন।' },
          icon: 'Award',
          link: '/support/donors',
          color: 'text-primary',
          bg: 'bg-primary/10'
      ...
      impact: {
        title: { en: 'The Impact of Your Support', bn: 'আপনার সাহায্যের সুফল' },
        subtitle: { en: 'See how your contributions are making a real difference in the community.', bn: 'আপনার অনুদান কীভাবে অবহেলিত মানুষের জীবনে পরিবর্তন আনছে তা দেখুন।' },
        stats: [
      ...
      donate: {
        page: {
          title: { en: 'Support Our Cause', bn: 'আমাদের মহৎ কাজে সহায়তা করুন' },
          subtitle: { en: 'Your contribution empowers people with disabilities and builds a more inclusive society.', bn: 'আপনার সহযোগিতা প্রতিবন্ধী ব্যক্তিদের জীবনমান উন্নয়ন এবং বৈষম্যহীন সমাজ গড়তে সহায়ক হবে।' }
        },
        form: {
          title: { en: 'Make a Donation', bn: 'অনুদান প্রদান' },
          description: { en: 'Choose an amount to contribute. Every bit helps us reach our goals.', bn: 'আপনার সামর্থ্য অনুযায়ী অনুদান প্রদান করুন। ক্ষুদ্রতম অনুদানও আমাদের এগিয়ে যেতে সাহায্য করে।' }
        },
        impactLevels: [
          { amount: 500, label: { en: 'Basic Support', bn: 'প্রাথমিক সহায়তা' }, impact: { en: 'Provides educational materials for 1 child for a month.', bn: '১টি শিশুর এক মাসের শিক্ষা উপকরণের খরচ।' } },
          { amount: 1000, label: { en: 'Health & Nutrition', bn: 'স্বাস্থ্য ও পুষ্টি' }, impact: { en: 'Covers essential health check-ups and nutrition for 1 child.', bn: '১টি শিশুর স্বাস্থ্য পরীক্ষা ও পুষ্টিকর খাবারের ব্যয়।' } },
          { amount: 2500, label: { en: 'Skill Training', bn: 'দক্ষতা প্রশিক্ষণ' }, impact: { en: 'Supports skill training for 1 person with disability.', bn: '১জন প্রতিবন্ধী ব্যক্তির কর্মমুখী প্রশিক্ষণে সহায়তা।' } },
          { amount: 5000, label: { en: 'Community Impact', bn: 'সামাজিক প্রভাব' }, impact: { en: 'Funds a community awareness workshop for 20+ people.', bn: '২০ জনেরও বেশি মানুষের জন্য একটি সচেতনতামূলক কর্মশালা।' } },
        ],
        paymentMethods: [
        ...
        transparency: {
          ...
          description: { en: 'We believe in full accountability. Here is how we allocate our resources to create impact.', bn: 'আমরা পূর্ণ জবাবদিহিতায় বিশ্বাস করি। সংগৃহীত তহবিলের সঠিক বণ্টন নিচে দেওয়া হলো।' },
          allocation: [
      ...
      volunteer: {
        page: {
          title: { en: 'Join Our Volunteer Team', bn: 'স্বেচ্ছাসেবী হিসেবে যুক্ত হোন' },
          subtitle: { en: 'Your time and skills can make a significant difference in the lives of persons with disabilities.', bn: 'আপনার সময় ও মেধা প্রতিবন্ধী ব্যক্তিদের জীবনে বড় পরিবর্তন আনতে পারে।' }
        },
        roles: [
          { title: { en: 'Event Support', bn: 'ইভেন্ট সহায়তা' }, desc: { en: 'Help us organize and manage our community events and awareness campaigns.', bn: 'আমাদের বিভিন্ন অনুষ্ঠান ও সচেতনতা কর্মসূচি আয়োজনে সহায়তা করুন।' }, icon: 'Calendar' },
          { title: { en: 'Skill Mentoring', bn: 'দক্ষতা প্রশিক্ষণ' }, desc: { en: 'Share your professional skills to mentor persons with disabilities in vocational training.', bn: 'প্রতিবন্ধী ব্যক্তিদের স্বাবলম্বী করতে বৃত্তিমূলক প্রশিক্ষণে আপনার জ্ঞান শেয়ার করুন।' }, icon: 'BookOpen' },
          { title: { en: 'Office Support', bn: 'দাপ্তরিক কাজ' }, desc: { en: 'Assist our administrative team with data entry, documentation, and communication.', bn: 'আমাদের দাপ্তরিক ও প্রশাসনিক কাজে সহায়তা করুন।' }, icon: 'FileText' },
        ]
      },
      partner: {
        page: {
          title: { en: 'Strategic Partnerships', bn: 'কৌশলগত অংশীদারিত্ব' },
          subtitle: { en: 'We collaborate with organizations to drive sustainable social inclusion.', bn: 'টেকসই সামাজিক উন্নয়ন নিশ্চিত করতে আমরা বিভিন্ন প্রতিষ্ঠানের সাথে কাজ করি।' }
        },
        types: [
          { title: { en: 'Corporate CSR', bn: 'কর্পোরেট সিএসআর' }, desc: { en: 'Align your corporate social responsibility goals with our impactful programs.', bn: 'আপনার প্রতিষ্ঠানের সামাজিক দায়বদ্ধতা (CSR) কার্যক্রম আমাদের মাধ্যমে বাস্তবায়িত করতে পারেন।' }, icon: 'Building2' },
          { title: { en: 'Institutional Support', bn: 'প্রাতিষ্ঠানিক সহযোগিতা' }, desc: { en: 'Joint initiatives with NGOs, government bodies, and international agencies.', bn: 'অন্যান্য এনজিও, সরকারি সংস্থা এবং আন্তর্জাতিক উন্নয়ন সংস্থার সাথে যৌথ উদ্যোগ।' }, icon: 'Globe' },
      ...
      donors: {
        page: {
          ...
          subtitle: { en: 'We are deeply grateful to the organizations that support our mission to empower persons with disabilities.', bn: 'প্রতিবন্ধী ব্যক্তিদের উন্নয়নে যারা আর্থিকভাবে আমাদের পাশে দাঁড়িয়েছেন, তাদের প্রতি আমরা কৃতজ্ঞ।' }
        }
      }
    },
    visionMission: {
      page: {
        ...
        subtitle: { en: 'Our guiding principles for creating an inclusive society.', bn: 'একটি সুন্দর বৈষম্যহীন সমাজ গঠনের পথপ্রদর্শক নীতিসমূহ।' },
      },
      vision: {
        title: { en: 'Our Vision', bn: 'আমাদের স্বপ্ন' },
        text: { en: 'A non-discriminatory society where people with disabilities enjoy their rights and responsibilities and they are fully capable of participating spontaneously at every level of society.', bn: 'একটি বৈষম্যহীন সমাজ যেখানে প্রতিবন্ধী ব্যক্তিরা তাদের অধিকার ও দায়িত্ব ভোগ করবে এবং সমাজের প্রতিটি স্তরে স্বতঃস্ফূর্তভাবে অংশগ্রহণের সুযোগ পাবে।' }
      },
      mission: {
        title: { en: 'Our Mission', bn: 'আমাদের মূল লক্ষ্য' },
        text: { en: 'The main goal of the organization is to create a barrier-free environment and rights-based integrated society for the very poor disabled men, women and children who are backward in all fields.', bn: 'সকল ক্ষেত্রে পিছিয়ে থাকা অতি দরিদ্র প্রতিবন্ধী পুরুষ, নারী ও শিশুদের জন্য একটি বাধামুক্ত পরিবেশ এবং অধিকারভিত্তিক সমন্বিত সমাজ গঠন করা।' }
      },
      values: {
        title: { en: 'Our Core Values', bn: 'আমাদের মূল্যবোধ' },
        desc: { en: 'These values define our culture and guide our actions as we work towards social justice and inclusion.', bn: 'এই আদর্শগুলোই আমাদের প্রতিটি কাজের অনুপ্রেরণা এবং সামাজিক ন্যায়বিচার প্রতিষ্ঠার পথপ্রদর্শক।' },
        list: [
          { en: 'Inclusivity', bn: 'সকলের অন্তর্ভুক্তি' },
          { en: 'Integrity', bn: 'সততা ও নিষ্ঠা' },
          { en: 'Empowerment', bn: 'সক্ষমতা বৃদ্ধি' },
          { en: 'Compassion', bn: 'সহমর্মিতা' },
        ]
      },
      join: {
        title: { en: 'Join Us in Our Mission', bn: 'আমাদের সাথে যুক্ত হোন' },
    ...
    governingBody: {
      ...
      intro: {
        ...
        description: { en: 'The governing body of SPUS consists of dedicated individuals who have lived experience with various disabilities. This unique perspective allows us to design programs that truly meet the needs of our community.', bn: 'এসপিইউএস-এর পরিচালনা পর্ষদ এমন ব্যক্তিদের নিয়ে গঠিত যারা নিজেরা প্রতিবন্ধকতার মুখোমুখি হয়েও অদম্য। তাদের বাস্তব অভিজ্ঞতা আমাদের কর্মসূচিগুলোকে আরও কার্যকর করে তোলে।' },
      },
      focal: {
        title: { en: 'Focal Person', bn: 'যোগাযোগের প্রধান ব্যক্তি' },
      ...
      members: {
        ...
        subtitle: { en: 'A team of 100% disabled leaders driving social change.', bn: 'প্রতিবন্ধী নেতাদের একটি শক্তিশালী দল, যারা সামাজিক পরিবর্তনের কারিগর।' },
        list: [
      ...
      governance: {
        ...
        subtitle: { en: 'We maintain strict governance protocols to ensure accountability and effective decision-making.', bn: 'সঠিক সিদ্ধান্ত গ্রহণ ও জবাবদিহিতা নিশ্চিত করতে আমরা কঠোর সাংগঠনিক নিয়ম মেনে চলি।' },
        ecm: {
          title: { en: 'Executive Committee Meetings', bn: 'কার্যনির্বাহী কমিটির সভা' },
          desc: { en: 'Organized every 3 months as per Article 20 of the Constitution of SPUS. Decisions include committee approval, legal assistance, and action planning.', bn: 'সংগঠনের গঠনতন্ত্রের ২০ ধারা অনুযায়ী প্রতি ৩ মাস অন্তর এই সভা অনুষ্ঠিত হয়, যেখানে গুরুত্বপূর্ণ প্রশাসনিক ও আইনি সিদ্ধান্ত গৃহীত হয়।' },
          tag: { en: '4 Meetings per Year', bn: 'বছরে ৪টি সভা' }
        },
        agm: {
          title: { en: 'Annual General Meeting', bn: 'বার্ষিক সাধারণ সভা' },
          desc: { en: 'Held annually to review income-expenditure, appoint auditors, and approve the annual work plan and budget.', bn: 'প্রতি বছর আয়-ব্যয় পর্যালোচনা, অডিটর নিয়োগ এবং পরবর্তী বছরের কর্মপরিকল্পনা অনুমোদনের জন্য এই সভা অনুষ্ঠিত হয়।' },
    ...
    legalStatus: {
      ...
      intro: {
        title: { en: 'Fully Registered & Governed', bn: 'নিবন্ধিত এবং স্বীকৃত প্রতিষ্ঠান' },
        description: { en: 'BPKS Satarkul is a non-profit, non-political, and non-governmental organization registered under the laws of Bangladesh. We maintain strict compliance with all regulatory bodies.', bn: 'বিপিকেএস সাতারকুল বাংলাদেশ সরকারের অধীনে নিবন্ধিত একটি অলাভজনক ও অরাজনৈতিক স্বেচ্ছাসেবী সংস্থা। আমরা সকল সরকারি নীতিমালা মেনে কার্যক্রম পরিচালনা করি।' },
        features: [
          { en: 'Regular Audit Compliance', bn: 'নিয়মিত অডিট কার্যক্রম' },
          { en: 'Transparent Financial Reporting', bn: 'স্বচ্ছ আর্থিক হিসাব' },
  ...
  programs: {
    page: {
      ...
      subtitle: { en: 'Discover how we support and empower persons with disabilities through various initiatives.', bn: 'বিভিন্ন উদ্যোগের মাধ্যমে আমরা কীভাবে প্রতিবন্ধী ব্যক্তিদের স্বাবলম্বী করছি, তা বিস্তারিত জানুন।' },
    },
    learnMore: { en: 'Learn More', bn: 'আরও জানুন' },
    list: [
      {
        ...
        desc: { en: 'Quality education for children with disabilities at Satarkul Diversity Disabled School.', bn: 'সাতারকুল বৈচিত্র্য প্রতিবন্ধী বিদ্যালয়ের মাধ্যমে বিশেষ শিশুদের মানসম্মত শিক্ষা প্রদান।' }
      },
      {
        id: 'health',
        title: { en: 'Health Services', bn: 'স্বাস্থ্যসেবা কার্যক্রম' },
        desc: { en: 'Comprehensive health support and medical assistance for persons with disabilities.', bn: 'প্রতিবন্ধী ব্যক্তিদের সুচিকিৎসা এবং প্রয়োজনীয় স্বাস্থ্য সহায়তা নিশ্চিতকরণ।' }
      },
      {
        id: 'skill-development',
        title: { en: 'Skill Development', bn: 'দক্ষতা উন্নয়ন প্রশিক্ষণ' },
        desc: { en: 'Vocational training in handicrafts, tailoring, and art for economic empowerment.', bn: 'আর্থিক স্বনির্ভরতার জন্য হস্তশিল্প, সেলাই এবং বিভিন্ন বৃত্তিমূলক প্রশিক্ষণ।' }
      },
      {
      ...
      },
      {
        ...
        desc: { en: 'Distributing wheelchairs, crutches, and other assistive devices for mobility.', bn: 'চলাচলের সুবিধার জন্য হুইলচেয়ার, ক্রাচ এবং অন্যান্য সহায়ক সামগ্রী বিতরণ।' }
      },
      {
        id: 'awareness',
        title: { en: 'Awareness Program', bn: 'সচেতনতামূলক কার্যক্রম' },
        desc: { en: 'Promoting disability rights and social inclusion through community awareness.', bn: 'প্রতিবন্ধী অধিকার এবং সামাজিক অন্তর্ভুক্তি বিষয়ে সচেতনতা বৃদ্ধি।' }
      },
      {
        id: 'social-support',
        title: { en: 'Social Support Services', bn: 'সামাজিক সহায়তা সেবা' },
        desc: { en: 'Empowering disabled individuals through documentation and legal assistance.', bn: 'কাগজপত্র প্রস্তুত এবং আইনি সহায়তার মাধ্যমে প্রতিবন্ধী ব্যক্তিদের অধিকার প্রতিষ্ঠা।' }
      },
      {
        id: 'special-programs',
        title: { en: 'Special Programs', bn: 'বিশেষ কার্যক্রম' },
        desc: { en: 'Innovative initiatives designed for specialized care and development.', bn: 'বিশেষ যত্ন এবং উন্নয়নের লক্ষ্যে পরিচালিত আধুনিক ও উদ্ভাবনী উদ্যোগ।' }
      }
    ],
    details: {
      education: {
        title: { en: "Inclusive Education Program", bn: "অন্তর্ভুক্তিমূলক শিক্ষা কার্যক্রম" },
        subtitle: { en: "Providing quality education and specialized support for children with disabilities.", bn: "প্রতিবন্ধী শিশুদের জন্য আধুনিক শিক্ষা এবং বিশেষ সহায়তামূলক উদ্যোগ।" },
        intro: {
          ...
          description: { en: 'In 2014, based on field surveys and discussions with parents of disabled children, it was found that disabled children are in the most vulnerable position in Bangladesh in terms of receiving education. Although the primary education enrollment rate is 97 percent, only 11 percent of children with disabilities receive any form of education. Due to lack of birth registration, many children with disabilities experience deprivation from the beginning of their lives. Due to lack of awareness and finances in very poor families, backward disabled children focus on begging instead of education. After reviewing this situation, Satarkul Development Organization for Disability took the initiative to establish a school for very poor disabled children who are deprived of educational opportunities.', bn: '২০১৪ সালে জরিপের মাধ্যমে দেখা যায় যে বাংলাদেশের প্রতিবন্ধী শিশুরা শিক্ষার ক্ষেত্রে সবচেয়ে বেশি অবহেলিত। প্রাথমিক শিক্ষায় ভর্তির হার ৯৭ শতাংশ হলেও প্রতিবন্ধী শিশুদের ক্ষেত্রে তা মাত্র ১১ শতাংশ। অর্থাভাব এবং সচেতনতার অভাবে অনেক দরিদ্র পরিবারের শিশুরা শিক্ষার পরিবর্তে ভিক্ষাবৃত্তিতে জড়িয়ে পড়ে। এই বাস্তবতাকে সামনে রেখে সুবিধাবঞ্চিত শিশুদের জন্য এসপিইউএস এই বিশেষ বিদ্যালয়টি চালু করে।' },
          classes: [
        ...
        curriculum: {
          ...
          items: [
            ...
            { en: 'Cooking, Proper Dressing, Hand-Foot Washing Rules', bn: 'রান্না, ব্যক্তিগত পরিচ্ছন্নতা ও জীবনমুখী আচার-আচরণ' },
          ]
        },
        stats: {
      ...
      health: {
        ...
        subtitle: { en: "Providing essential healthcare and medical support to our community.", bn: "অসহায় মানুষের জন্য প্রয়োজনীয় চিকিৎসা এবং স্বাস্থ্যসেবা নিশ্চিতকরণ।" },
        intro: {
          tag: { en: 'Health Services', bn: 'স্বাস্থ্যসেবা' },
          title: { en: 'Comprehensive Health Support', bn: 'সমন্বিত স্বাস্থ্য সহায়তা' },
          description: { en: 'We provide essential healthcare services, including regular checkups, specialized therapies, and emergency medical support to persons with disabilities in our community.', bn: 'আমরা স্থানীয় প্রতিবন্ধী ব্যক্তিদের নিয়মিত স্বাস্থ্য পরীক্ষা, বিশেষায়িত থেরাপি এবং জরুরি চিকিৎসা সেবা প্রদান করে আসছি।' },
        ...
        services: [
          { title: { en: 'Medical Checkups', bn: 'স্বাস্থ্য পরীক্ষা' }, desc: { en: 'Regular health screenings and general medical checkups for disabled individuals.', bn: 'প্রতিবন্ধী ব্যক্তিদের জন্য নিয়মিত সাধারণ স্বাস্থ্য পরীক্ষার ব্যবস্থা।' }, icon: 'Stethoscope', color: 'bg-primary/10 text-primary', timeline: { en: 'Monthly', bn: 'মাসিক' } },
          { title: { en: 'Physiotherapy', bn: 'ফিজিওথেরাপি' }, desc: { en: 'Specialized physical therapy sessions to improve mobility and strength.', bn: 'চলাচল ও শারীরিক সক্ষমতা বৃদ্ধিতে বিশেষ থেরাপি সেশন।' }, icon: 'Activity', color: 'bg-secondary/10 text-secondary', timeline: { en: 'Weekly', bn: 'সাপ্তাহিক' } },
      ...
      'skill-development': {
        ...
        intro: {
          ...
          description: { en: 'Our skill development program focuses on providing sustainable livelihoods for disabled women, adolescent girls, and their guardians. By teaching creative and practical skills, we help them achieve financial independence and social recognition.', bn: 'আমাদের এই কর্মসূচির লক্ষ্য হলো প্রতিবন্ধী নারী, কিশোরী এবং তাদের অভিভাবকদের আয়ের পথ তৈরি করে দেওয়া। সৃজনশীল ও ব্যবহারিক কাজের মাধ্যমে আমরা তাদের স্বাবলম্বী করে তুলি।' },
      ...
      'financial-support': {
        ...
        grants: [
          { 
            ...
            items: [
              { name: { en: 'Shop Rent', bn: 'দোকান ভাড়া' }, purpose: { en: 'Advance Payment', bn: 'অগ্রিম অগ্রিম' }, icon: 'Home', amount: '11,000' },
      ...
      'special-programs': {
        title: { en: 'Special Programs', bn: 'বিশেষ কার্যক্রম' },
        subtitle: { en: 'Innovative initiatives designed for specialized care and development.', bn: 'বিশেষ যত্ন এবং নিবিড় উন্নয়নের লক্ষ্যে পরিচালিত আধুনিক উদ্যোগসমূহ।' },
        hero: {
  ...
  activities: {
      ...
      advocacy: {
        ...
        methodsTitle: { en: 'How We Advocate', bn: 'আমরা যেভাবে কথা বলি' },
        methodsSubtitle: { en: 'Our methods for bringing attention to the needs and rights of our community.', bn: 'প্রতিবন্ধী মানুষের চাহিদা ও অধিকার আদায়ে আমাদের ব্যবহৃত পদক্ষেপসমূহ।' },
        activities: [
          {
            id: 'human-chains',
            icon: 'Users',
        ...
        ctaDescription: { en: 'Your presence strengthens our demands. Join us in our next human chain or press conference to make a difference.', bn: 'আপনার উপস্থিতি আমাদের দাবিগুলোকে আরও শক্তিশালী করবে। আগামী মিছিলে বা মানববন্ধনে আমাদের পাশে থাকুন।' },
      ...
      meetings: {
        ...
        list: [
          ...
          },
          {
            ...
            title: { en: "Women's Council OPID Meeting", bn: 'নারী পরিষদের অপিডির মিটিং' },
  ...
  contact: {
    ...
    form: {
      ...
      success: { en: 'Message sent successfully!', bn: 'আপনার বার্তাটি সফলভাবে পাঠানো হয়েছে!' },
      subjects: {
    ...
    faq: {
      ...
      subtitle: { en: 'Quick answers to common questions about our organization and services.', bn: 'আমাদের সংস্থা ও সেবা সম্পর্কে সাধারণ কিছু প্রশ্নের দ্রুত সমাধান।' },
    }
  }
};
